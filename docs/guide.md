...
Plain-language notes for the tape diagram, for what LLVM is doing in this repo, and for how that lines up with NIC DMA, firmware, PCIe, and the networking stack.
